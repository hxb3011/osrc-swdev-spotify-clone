  ...
  return (
    <>
      <TrackDownloadModal
        ...
        audioLink={playerState.audioSrc}
        videoLink={playerState.videoSrc}
        open={open}
      ...
      <div className="flex gap-2 items-center text-white">
        <div>
          <img
            className="h-16 w-16"
            src={playerState.trackImage || profilePhoto}
            alt=""
          />
        </div>
        <div className="flex flex-col justify-center">
          ...
          <div>
            {playerState.trackArtists &&
              playerState.trackArtists.length > 0 &&
              playerState.trackArtists.map((artist, index) => (
        ...
        <div className="flex items-center">
          <LikeButton
            styles={{ color: "white" }}
            liked={playerState.trackLiked}
            onClick={likeTrackHandler}
          />
          <IconButton
